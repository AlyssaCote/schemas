...
class Request:
    ...
    class Input:
        ...
        inputData: Tensor | TensorBuilder | TensorReader
        def which(self) -> Literal["inputKeys", "inputData"]: ...
        def init(self, name: Literal["inputData"]) -> Tensor: ...
        @staticmethod
        @contextmanager
        def from_bytes(
            data: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...
    ...
    class Output:
        ...
        outputData: Tensor | TensorBuilder | TensorReader
        def which(self) -> Literal["outputKeys", "outputData"]: ...
        def init(self, name: Literal["outputData"]) -> Tensor: ...
        @staticmethod
        @contextmanager
        def from_bytes(
            data: bytes, traversal_limit_in_words: int | None = ..., nesting_limit: int | None = ...
